    ...
    <div class="container box">
        <div class="card mt-3">
            <div class="card-body">
                ...
                <form id="form_register" class="mt-4 was-validated">
                    <div class="form-row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="forThai" id="forThai" required class="form-control">
                    ...
                    <div class="form-row mt-3">
                        <div class="col-md-8">
                            ...
                            <textarea rows="4" class="form-control is-invalid" name="homeAddress" id="homeAddress"
                                required></textarea>
                        </div>
                    </div>
